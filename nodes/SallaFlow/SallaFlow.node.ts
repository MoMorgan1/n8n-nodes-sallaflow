/*
 * The catalogue order is part of the established SallaFlow editor experience.
 * Keep it stable for saved workflows instead of alphabetizing unrelated fields.
 */
...
/* Machine-readable JSON examples intentionally use lowercase `id` keys. */
